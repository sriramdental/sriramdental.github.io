...
<meta name="description" content="">
 ...
 <section>
    <div class="pagenation-holder" style="background-image: url(images/shriram-banner-image.jpg)">
      <div class="container">
        <div class="row">
       <div class="col-md-6"> <h4>Dr. Vijjaykanth</h4></div>
        <div class="col-md-6">
        <ol class="breadcrumb">
    <li><a href="#">Home</a></li>

    <li class="current"><a href="#">Dr. Vijjaykanth</a></li>
</ol>
</div>
 ...
 <div class="dt-feature-box-5 margin-bottom">
            ...
            <li class="last"><a href="https://twitter.com/sriramlaserdental"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="text-box text-left">
                  ...
                  <p>He is the first SureSmile Aligner(USA) Key Opinion Leader in India. His area of special interest is Adult Orthodontics.</p>
 ...
 <div class="text-box white padding-5">
  ...
  <div class="col-xs-12 nopadding">
            <div class="sec-title-container less-padding-3 text-left">
              ...
              <h4 class="uppercase font-weight-7 less-mar-1">Dr. Vijjaykanth</h4>
              <div class="clearfix"></div>
              <p class="by-sub-title">B.D.S, M.D.S(Orthodontics & Dentofacial Orthopedics)</p>
            </div>
          </div>
            <div class="clearfix"></div>
            <!--end title-->

  <h4 class="raleway">Dr. Vijjaykanth has completed his B.D.S., in 1998 from the prestigious Tamilnadu Government Dental College and Hospital and went on to do M.D.S (Orthodontics & Dentofacial Orthopedics) in the same college.</h4>
<p>He is the first KOL ( Key Opinion Leader) for SureSmile Aligners (USA) in India. He has undergone exclusive training for SureSmile aligners in Germany. His area of special interest is in Adult Orthodontics dealing with a multidisciplinary approach, clear aligners, Tempero-Mandibular joint disorders (TMD),and Dentofacial Orthopedics. He has undergone special training in Dental Implants.</p>
<p>He is an alumni & Fellow of Madras Medical College(FMMC). He is a Life Member of IOS (Indian Orthodontic Society), IALD (Indian Academy of Laser Dentistry), ISDR(Indian Society for Dental Research) and IDA(Indian Dental Association). After working in various Government Hospitals in the state and Government Stanley Medical College, he is currently working as Associate Professor in Tamil Nadu Government Dental College and Hospital. He is a certified Invisalign provider. </p>
<br/>
